...
import { getSemestreOptions } from '../helpers/subjectHelpers';

const SubjectFilterSemester = ({ value, onChange }) => {
    const options = getSemestreOptions();
...
export default SubjectFilterSemester;